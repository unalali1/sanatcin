...
export const config = {
  ...
  sourceImageReviewLimit: boundedInteger('SOURCE_IMAGE_REVIEW_LIMIT', 3, 1, 5),
  ...
  minEditorialFit: boundedInteger('MIN_EDITORIAL_FIT', 5, 0, 10),
  categoryRescueMinCandidates: boundedInteger('CATEGORY_RESCUE_MIN_CANDIDATES', 2, 0, 8),
  rescueAiCandidates: boundedInteger('RESCUE_AI_CANDIDATES', 20, 0, 60),
